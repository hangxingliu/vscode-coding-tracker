...
//silent: if local server started, there are no any message
//times: how many times retry
//isActiveCheck: is this calling from active heart beat (It will be change log content)
...
module.exports = {
	...
	iDetectOldSeverMaybeExited_IfLocalMode_StartNew: () => {
		if (!userConfig.localMode)
			return false;
